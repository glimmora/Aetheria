// ============================================================
// Aetheria: Nine Isles - Tile Map Renderer
// Renders the visible portion of the island map + entities
// ============================================================

import React, { useMemo, useRef } from 'react'
import { TILE_INFO } from '../data/tiles.js'
import { getIslandMap, ISLAND_DEFS } from '../data/islands.js'
...
export default function TileMap({
  ...
  for (let y = 0; y < viewH; y++) {
    for (let x = 0; x < viewW; x++) {
      ...
      const info = TILE_INFO[tile] || { color: '#000', walkable: false }
      tiles.push(
        <div
          key={`${x}-${y}`}
          className="tile"
  ...
  return (
    <div
      ...
      style={{
        ...
        background: islandDef?.backgroundColor || '#000',
      }}
    >
      ...
      <div className="map-edge-info">
        {islandDef?.name} — {islandDef?.subtitle}
      </div>
    </div>
  )
}
