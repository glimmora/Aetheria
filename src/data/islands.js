// ============================================================
// Aetheria: Nine Isles - Master island definitions
...
// ============================================================
const luminaNpcs = [
  { id: 'lumina elder_ravenna', name: 'Elder Ravenna', role: 'Village Elder', x: 0, y: 0, color: '#fde047', dialog: 'Welcome, traveler, to Lumina Isle, the first spark of Aetheria. Our isle is gentle, but the world beyond is not. Speak with our folk, and you will find your purpose.', shop: null },
...
const emberfallNpcs = [
  ...
  { id: 'ember broker', name: 'Ember Broker', role: 'Merchant', x: 0, y: 0, color: '#facc15', dialog: 'Ember essence is in high demand across Aetheria. Sell it to me, and I will pay you well.', shop: { name: "Broker's Stall", items: [{ id: 'ember_essence', price: 30, stock: 0 }, { id: 'health_potion', price: 25, stock: 10 }] }, quest: 'ember_essence_trade' },
...
const mistwoodNpcs = [
  ...
  { id: 'mist traveler', name: 'Wandering Traveler', role: 'Traveler', x: 0, y: 0, color: '#9ca3af', dialog: 'I have walked all of Aetheria. The Mistwood hides secrets. Slay fifteen moss snakes and I will share one with you.', shop: null, quest: 'mist_secret' },
...
// ============================================================
const sunscarNpcs = [
  { id: 'sun vizier_khalid', name: 'Vizier Khalid', role: 'Royal Vizier', x: 0, y: 0, color: '#fbbf24', dialog: 'The Sun Titan awakens in the great pyramid. He has burned our oases dry. Stop him, hero of Aetheria.', shop: null, quest: 'sun_titan' },
...
// ============================================================
const shadowfenNpcs = [
  { id: 'sf witch_morgana', name: 'Witch Morgana', role: 'Swamp Witch', x: 0, y: 0, color: '#7c3aed', dialog: 'The Lich Queen Mortis stirs in the fetid depths. Slay her, or all of Aetheria drowns in shadow.', shop: null, quest: 'sf_lich_queen' },
...
// ============================================================
const skyreachNpcs = [
  { id: 'sky archmage_solara', name: 'Archmage Solara', role: 'Archmage', x: 0, y: 0, color: '#fde047', dialog: 'The Thunder Drake nests atop Skyreach. It must be slain before it lays its eggs, or Aetheria will face a storm of wyrms.', shop: null, quest: 'sky_drake' },
...
// ============================================================
const voidheartNpcs = [
  { id: 'void watcher_aza', name: 'Watcher Aza', role: 'Void Watcher', x: 0, y: 0, color: '#7c3aed', dialog: 'You have come at last. The Voidlord Acheron tears reality itself. Slay him, and Aetheria will be saved.', shop: null, quest: 'void_acheron' },
  ...
  { id: 'void oracle', name: 'Final Oracle', role: 'Oracle', x: 0, y: 0, color: '#fbbf24', dialog: 'I see the end of all things, or the beginning. Slay the Voidlord, and a new age dawns for Aetheria.', shop: null },
  ...
  { id: 'void keeper', name: 'Last Keeper', role: 'Keeper', x: 0, y: 0, color: '#fde047', dialog: 'I am the last keeper of Aetheria\'s hope. You are that hope. Go now, and unmake the void.', shop: null },
]
...
export const ISLAND_DEFS = {
  ...
  voidheart: {
    ...
    biome: 'voidheart',
    levelRange: [18, 25],
    description: 'A realm of pure darkness where reality itself unravels. The Voidlord Acheron tears at the fabric of existence, and only the mightiest heroes of Aetheria may challenge him. The fate of all worlds rests here.',
...
function isWalkableCheck(map, x, y) {
  ...
  const info = TILE_INFO_LOOKUP(map[y][x])
  return info.walkable
}

import { TILE_INFO } from './tiles.js'
function TILE_INFO_LOOKUP(t) { return TILE_INFO[t] || { walkable: false } }
